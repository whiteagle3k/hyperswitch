...
pub struct ConnectorConfig {
    ...
    pub everypay: Option<ConnectorTomlConfig>,
    ...
    pub makecommerce: Option<ConnectorTomlConfig>,
...
impl ConnectorConfig {
    ...
    pub fn get_connector_config(
        ...
        match connector {
            ...
            Connector::Everypay => Ok(connector_data.everypay),
            ...
            Connector::Makecommerce => Ok(connector_data.makecommerce),
